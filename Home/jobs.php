...
<body>
		...
		<div class="section">
			<div class="header_container">
				<nav class="navbar">
					...
					<ul>
						<li><a href="../Recruiter/profile/index.php">Home</a></li>
    ...
    <div class="wrapper">
        <div class="container">
            <div class="header">
                <h2 style="position: absolute; height:70px;">Job post from Recruiter</h2>
                ...
                <form action="update_recruiter_post_emp.php?post_id=<?php echo $post_id; ?>" method="post" class="viewapplicant">
