...
(7, 'Najmul', 'Hasan', 'rifat', 'male', 'Dhaka', '01865479342', 'rifat@gmail.com', '1212', '123', 'pending');

-- --------------------------------------------------------

--
-- Table structure for table `recruiter_complain`
--

CREATE TABLE `recruiter_complain` (
...
--
-- Dumping data for table `recruiter_complain`
--

INSERT INTO `recruiter_complain` (`complain_id`, `recruiter_id`, `user_name`, `email`, `contact`, `complain_details`) VALUES
(0, 1, 'mobin', 'abdulmobin417@gmail.com', '01759425952', 'dsghxgfjghnjfgbzgg');
...
(2, 1, 'abdulmobin417@gmail.com', 1759425952, 'asgfdrhrhrfeswfetgetg');
...
(3, 2, 'sahadat', 'sahadat@gmail.com', '01865479342', 'gdtruyiyjgfht');

-- --------------------------------------------------------

--
-- Table structure for table `seeker_cv`
--
...
CREATE TABLE `seeker_cv` (
  ...
  `ex_job_position` varchar(255) DEFAULT NULL,
  `ex_company` varchar(255) DEFAULT NULL,
  `ex_duration` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `seeker_cv`
--

INSERT INTO `seeker_cv` (`cv_id`, `seeker_id`, `bio`, `skill`, `education1`, `university1`, `department1`, `education2`, `university2`, `department2`, `ex_job_position`, `ex_company`, `ex_duration`) VALUES
(5, 2, 'I am studying B.Sc in CSE at United International University (UIU). Currently, I am a Penetration Tester of web application. I am also doing web application Professional Pentest Report. I have already done 5 projects in this field.I am a Certified Network Security Specialist from ICSI and Splunk completion Certified User. I have 8 certificate of completion in cyber security field. I consider myself as an intermediate Python Programmer who loves to solve problems and try to automate boring staff and explore new things that can be done using this in security space. I got a Basic Python Certificate from HACKER RANK. Now I am looking for Cyber security-related jobs where I can able to increase my knowledge.', 'Administration', 'Bachelor', 'United International University', 'CSE', 'Masters', 'United International University', 'EEE', 'Security', 'Brain Station', 'JAN 2016-DEC 2019'),
(6, 6, 'dfshjyhklhDSfredyhdreg', 'dsgdfhdfgesdr', 'Bachelor', 'uiu', 'cse', 'Masters', 'NSU', 'EEE', 'security', 'IBM', '2 year');
...
(7, 'Administration', 'Jan 30, 2022 10:01:00');
...
(6, 'Administration', 'Passed', NULL, NULL, 3, 'Wrong011191206Wrong011191206Wrong011191206Wrong011191206Wrong011191206Wrong011191206Wrong011191206011191206011191206', NULL),
(7, 'Administration', 'Pending', NULL, NULL, 0, 'Wrong011191206Wrong011191206Wrong011191206Wrong011191206Wrong011191206Wrong011191206Wrong011191206011191206011191206', NULL);
...
--
-- Indexes for table `recruiter_complain`
--
ALTER TABLE `recruiter_complain`
...
--
-- Indexes for table `seeker_cv`
--
ALTER TABLE `seeker_cv`
...
--
ALTER TABLE `job_seeker`
  MODIFY `job_seeker_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `recruiter_review_box`
--
ALTER TABLE `recruiter_review_box`
  MODIFY `recruiter_review_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT for table `seeker_cv`
--
ALTER TABLE `seeker_cv`
...
--
-- Constraints for table `recruiter_complain`
--
ALTER TABLE `recruiter_complain`
  ADD CONSTRAINT `recruiter_complain_ibfk_1` FOREIGN KEY (`recruiter_id`) REFERENCES `job_recruiter` (`recruiter_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `seeker_cv`
--
ALTER TABLE `seeker_cv`
  ADD CONSTRAINT `seeker_cv_ibfk_1` FOREIGN KEY (`seeker_id`) REFERENCES `job_seeker` (`job_seeker_id`) ON DELETE CASCADE ON UPDATE CASCADE;
